...
public class WeatherPanelBig extends JPanel implements ModuleInterface{
	...
	public WeatherPanelBig(){
		...
		lblWeatherPic1.setBounds(0, 0, 1074, 160);
		...
		panel_2.setBounds(358, 160, 360, 160);
		add(panel_2);
		...
		panel_3.setBounds(714, 160, 360, 160);
		add(panel_3);
		
		JLabel lblWeatherConditions4 = new JLabel("WeatherConditions");
		...
		JLabel lblTemperature4 = new JLabel("Temperature");
