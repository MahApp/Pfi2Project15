...
public class CanvasInJframe extends JFrame {
	...
	public Font futuraMedium = new Font("Futura LT Regular", Font.PLAIN,fontSize);// typsnittet vi ska anv�nda
	...
	class MyCanvas extends Canvas {
		...
		//	boolean colorTurn = false;
			...
			// Str�ngar i en array som lagras i en lista, som sen ska skrivas ut
			// i respektive f�lt
