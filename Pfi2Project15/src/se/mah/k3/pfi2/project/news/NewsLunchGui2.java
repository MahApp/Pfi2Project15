...
public class NewsLunchGui2 extends JPanel {
	...
	public NewsLunchGui2() {
		...
		st.readAndWriteMonday();
			...
			panel2.add(Rubrik);
					...
					panel.setBounds(425, 0, 218, 50);
					panel2.add(panel);
					
					JLabel lblKalendarium = new JLabel("Kalendarium");
					lblKalendarium.setForeground(Color.WHITE);
