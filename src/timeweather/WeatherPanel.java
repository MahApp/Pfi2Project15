...
public class WeatherPanel extends JPanel implements ModuleInterface{
	...
	public WeatherPanel(){
		...
		lblTemperature.setFont(new Font("Futura", Font.PLAIN, 36));
		...
		lblNu.setFont(new Font("Futura", Font.PLAIN, 24));
		...
		lblTime2.setFont(new Font("Futura", Font.PLAIN, 24));
		...
		lblTemperature2.setFont(new Font("Futura", Font.PLAIN, 36));
		...
		lblTemperature3.setFont(new Font("Futura", Font.PLAIN, 36));
		lblTemperature3.setBounds(143, 43, 80, 80);
		panel_2.add(lblTemperature3);
		
		lblTime3 = new JLabel("Time");
		lblTime3.setFont(new Font("Futura", Font.PLAIN, 24));
